---
notice: 'This file is imported and can be edited at https://github.com/amphp/postgres/blob/2.x/README.md'
title: 'Postgres Connection Pool in PHP'
description: 'Learn how to query and update data in Postgres databases.'
image: undraw/undraw_fishing.svg
permalink: /postgres
source: 'https://github.com/amphp/postgres/blob/2.x/README.md'
layout: docs
---
